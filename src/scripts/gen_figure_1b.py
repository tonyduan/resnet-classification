...
if __name__ == "__main__":
    ...
    argparser.add_argument("--dir", type=str, default="cifar100_pgd")
    argparser.add_argument("--score", type=str, default="nll")
    args = argparser.parse_args()

    df = defaultdict(list)

    EXPERIMENTS = ("cifar100_pgd_wd_1e-4",)
    ...
    grid = sns.relplot(data=df, kind="line", x="epoch", y="score", row="experiment", col="measure",
                       hue="split", style="adv", hue_order=("train", "test"), dashes={"none": "", "pgd": (2, 5)},
    ...
    grid.axes[0][3].set_ylim((0, 1))
    grid.tight_layout()
    grid.savefig("./figs/figure_1b.pdf")
    plt.show()
